...
<template>
    <!--REF:https://codepen.io/PaulRyan17/pen/bGVeeZw?editors=1010-->
    <div class="flex flex-col items-center justify-center w-full h-full gap-8">
        <svg
            ...
            width="180"
            height="60"
            viewBox="0 0 617.78 199.52"
            style="enable-background: new 0 0 617.78 199.52"
            xml:space="preserve"
        >
            <defs></defs>
            <path
                ...
                class="st0"
                fill="#daa621"
                d="M228.02,97.17c-9.21,4.19-12.49,3.48-18.36-3.98v0c-5.88-7.47-5.34-17.87,1.63-31.34
	...
	C238.3,84.28,235.9,93.58,228.02,97.17"
            ...
            <path
                ...
                class="st0"
                fill="#daa621"
                d="M385.24,98.25c-7.17-11.99,6.15-12.26,3.2-45.74c-0.64-20.72-0.09-24.48,4.48-30.67
	...
	c-14.31-28.16,0.46,11.02,3.42,19.04c-5.03,7.83-13.8,18.34-23.01,13.58"
            ...
            <g id="body">
                <path
                    class="st0"
                    fill="#daa621"
                    d="M300.54,199.23c-18.46-22.41-19.87-79.89-56.98-89.3c-7.02-1.54-7.69-2.44-6.21-8.33
		...
		z"
                ...
                <path
                    class="st0"
                    fill="#daa621"
                    d="M274.24,190.69c-11.33-5.61-21.34-14.96-11.98-11.19c4.29,2.44,27.01,5.9,28.2,12.16
		C291.53,197.23,286.89,196.95,274.24,190.69L274.24,190.69z"
                />
                <path
                    class="st0"
                    fill="#daa621"
                    d="M328.3,193.99c-2.46-8.09,26.08-15.81,31.7-14.55C361.49,179.97,330.64,201.33,328.3,193.99z"
                />
                <path
                    class="st0"
                    fill="#daa621"
                    d="M270.85,179.57c-15.9-5.58-30.81-18.16-32.69-31.35c9,4.93,20.25,10.07,30.86,11.56
		c11.02,1.65,11.82,2.32,15.36,12.69C288.6,184.84,288.36,184.96,270.85,179.57z"
                />
                <path
                    class="st0"
                    fill="#daa621"
                    d="M334.55,175.64c4.93-15.8,5.52-16.42,16.86-17.7c8.71-0.1,22.26-7.36,28.18-8.72
		c-3.74,14.55-17.41,28.07-37.28,30.61C333.04,181.51,332.77,181.36,334.55,175.64z"
                />
                <path
                    class="st0"
                    fill="#daa621"
                    d="M260.72,155.06c-15.19-5.43-27.1-13.97-27.1-19.45c0-3.69,1.12-4.62,4.16-3.45c8.6,3.3,26.14,6.45,28.34,5.09
		c2.46-1.52,12.3,12.97,12.32,18.13C278.45,159.31,272.29,159.2,260.72,155.06L260.72,155.06z"
                />
                <path
                    class="st0"
                    fill="#daa621"
                    d="M343.21,153.71c0-5.8,7.58-17.43,10.6-16.27c1.7,0.65,8.98-0.34,16.17-2.21c13.01-3.38,13.08-3.36,13.08,2.42
		C384.21,149.98,342.38,159.74,343.21,153.71z"
                />
                <path
                    class="st0"
                    fill="#daa621"
                    d="M241.71,130.49c-7.01-2.25-8.09-3.72-8.09-10.95c0-9.52,1.13-9.86,14.74-4.41
		c8.34,3.34,17.63,12.37,17.63,17.14C266,134.43,250.46,133.3,241.71,130.49z"
                />
                <path
                    class="st0"
                    fill="#daa621"
                    d="M353.17,131.58c0-3.93,15.69-18,21.77-19.52c6.88-1.73,10.51,2,10.57,10.84c0.03,4.23-2.1,6.08-9.3,8.08
		C365.04,134.07,353.17,134.38,353.17,131.58L353.17,131.58z"
                />
                <path
                    class="st0"
                    fill="#daa621"
                    d="M247.94,89.54c-14.33-2.72,15.93-26.28,25.18-31.65c11.5-5.74,25.25-10.08,25.25-7.95
		c0,3.68-19.17,32.36-24.34,36.43C268.2,90.95,258.07,92.19,247.94,89.54L247.94,89.54z"
                />
                <path
                    class="st0"
                    fill="#daa621"
                    d="M347.96,87.65c-9.41-5.26-29.88-34.36-26.53-37.71c14.05-2.16,54.77,29.47,50.34,36.1
        ...
        <div class="flex flex-col items-center gap-2 w-48">
            <div class="w-full h-[2px] bg-white/20 rounded-full overflow-hidden">
                <div
                    class="h-full bg-portal-color-gold rounded-full transition-all duration-300 ease-out"
                    :style="{ width: `${progress}%` }"
                />
            </div>
            <span class="text-portal-color-gold text-xs tracking-widest">
                {{ progress }}%
            </span>
        </div>
    </div>
